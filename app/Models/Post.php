...
class Post extends Model
{
    ...
    // Eager loading: Otomatis load relasi author dan category saat Post dipanggil
    ...
    // Query Scope: Filter pencarian berdasarkan search, category, atau nama author
